...
String signInOption = "تسجيل الدخول";
//en => sign in
String studentOption = "طالب";
//en => student
String employee = "موظف";
//en => employee
String guestOption = "ضيف";
//en => guest
...
String aboutTheUniversity = "عن الجامعة";
// en => About the university
String commonQuestions = "الأسئلة الشائعة";
// en => common questions
String admissionSystem = "نظام القبول";
// en => Admission system
String faculty = "كلية";
// en => Faculty
String theActivities = "النشاطات";
// en => the activities
String regulations = "اللوائح";
// en => Regulations
String universityBranches = "فروع الجامعة";
// en => University branches
String website = "الموقع الالكتروني";
// en => website
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
String characteristic = 'ما هي صفة قيد الطالب بالدراسة ؟';
// en => What is the characteristic of a student studying to study?
String accepted =
    'يتم قبول الطلاب وقيدهم بأحد كليات الجامعة وفق الفئات التالية ';
// en => Students are accepted and enrolled in one of the university’s colleges according to the following categories
String a = 'أ –طلاب نظاميون وتشمل هذه الفئة جميع الطلاب المتفرغين للدراسة .';
// en => A - Regular students. This category includes all students who study full-time.
String b = 'ب –طلاب غير نظاميين وهم الطلاب الذين تحول ظروفهم دون ذلك .';
// en => B - Irregular students, which are students whose circumstances prevent this.
String c =
    'ج –طلاب وافدون تفتح جامعة سرت باب القبول للطلاب الوافدين (غير الليبيين)للدراسة بأحد كلياتها المختلفة سـواء كانوا طلاباً قادمين من دولهم بمنـح دراسية حسب الاتفاقيـات المبرمة في هـذا الشأن أو على حسابهم الخاص بحكم إقامتهم الاعتيادية بليبيا .';
// en => C - International students: The University of Sirte opens the door for admission to international students (non-Libyans) to study in one of its various colleges, whether they are students coming from their countries with scholarships according to the agreements concluded in this regard or at their own expense by virtue of their usual residence in Libya.
String qLan = 'ما هي لغة الدراسة بالجامعة ؟';
// en => What is the language of study at the university?
String aQuLan = 'أ -اللغة العربية هي لغة الدراسة المعتمدة بالجامعة.';
// en => A - Arabic is the approved language of study at the university.
String bQuLan =
    'ب -تعتبر اللغة الانجليزية هي لغة الدراسة المعتمدة في بعض كليات الجامعة مثل الهندسة ، الطب البشري ، طب الأسنان.';
// en => 'B - English is considered the approved language of study in some university colleges, such as engineering, human medicine, and dentistry.'

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
String admission = 'ما هي الشروط العامة للقبول ؟';
// en => What are the general conditions for admission?
String requiredToBeAccepted =
    'يشترط لقبول الطلبة للدراسة بإحدى كليات جامعة سرت وفقاً للشروط الآتية';
// en => Students are required to be accepted to study at one of the colleges of the University of Sirte in accordance with the following conditions
String aQuAc =
...
// en => A - The student must have a secondary school certificate from a Libyan school or an equivalent certificate recognized by the Ministry of Education and Scientific Research.
String bQuAc = 'ب –أن يكون قادراً صحياً على متابعة الدراسة في تخصصه المرغوب .';
// en => 'B - To be able to continue studying in his desired specialty.'
String cQuAc = 'ما هي الشروط العامة للقبول ؟';
// en => 'C - He must have obtained the approved percentage for college admission in accordance with the systems determined by the Ministry of Education.'
String dQuAc = '                         د –أن يكون مؤمن بقيم المجتمع وتوجهاته';
// en => 'D - To be a believer in the values ​​and trends of society.'
String eQuAc =
...
// en => 'E - If the applicant is a non-Libyan, he is required to be a regular resident of Libya for the duration of the study, and to pay the tuition fees and expenses in accordance with the regulations and systems in force in the universities.'

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
String iT = 'كلية تقنية المعلومات';
// en => Information Technology

String engineering = 'كلية الهندسة';
// en => Engineering

String hMedicine = 'كلية الطب البشري';
// en => Human Medicine

String dentistry = 'كلية طب الأسنان';
// en => Dentistry

String literature = 'كلية الاداب';
// en => 'Literature'

String agriculture = 'كلية الزراعة';
// en => Agriculture

String economics = 'كلية الاقتصاد';
// en => Economics

String education = 'كلية التربية';
// en => Education
...
// en => “The student shall be punished by suspension from study for a period of no less than two academic years if he commits one of the acts stipulated in Article (28) of these regulations. The student shall be expelled from the college or institute if he returns.”
String aEx =
...
// en =>'The student shall be punished by suspension from study for a period of not less than one academic year if he commits one of the acts stipulated in Article (29), and the penalty shall be doubled upon return.'
String bEx =
    'يعاقب على المخالفات المنصوص عليها في المادة (30) على النحو التالي';
// en =>'The violations stipulated in Article (30) shall be punished as follows'
String aQuEx =
...
// en =>'A - Anyone who commits the violations mentioned in Paragraphs (A-B) shall be punished by suspension from study for a period of not less than one academic year and not more than two academic years, and the student shall be permanently expelled from study upon return.'
String bQuEx =
...
// en =>'B- The student shall be punished by being deprived of taking the exams, in whole or in part, if he commits the violations specified in Paragraphs (C-D), and in all cases his exam shall be considered canceled in the subject in which he committed the violation.'
String cQuEx =
...
// en =>'C - Anyone who commits the violation described in Paragraph (E) shall be punished by canceling the results of his examination in at least one round, and the Disciplinary Council may cancel his examination for a full year and the student shall be expelled permanently upon return.'
String dQuEx =
...
// en =>'D- The violations stipulated in Paragraphs (F-G) shall be punished by deprivation of the rights of a regular student or suspension from study for a period not exceeding one academic year.
String eQuEx =
    'يشترط للقبول للدراسة بالكليات والمعاهد العليا لنيل أحدى المؤهلات المنصوص عليها في المادة (1) من هذه اللائحة ما يلي';
// en =>'The following are required for admission to study in colleges and higher institutes to obtain one of the qualifications stipulated in Article (1) of these regulations.'
String fQuEx =
...
// en =>'A- The student must have a secondary school certificate from a school in the Great Jamahiriya or an equivalent certificate recognized by the General People's Committee for Higher Education.'
String gQuEx =
    'ب- أن يكون قادراً صحياً على مـتابعة الدراسة في تخصـصه المــرغوب';
// en =>'B- He must be medically able to continue studying in his desired specialty.'
String hQuEx =
...
// en =>'C- He must have obtained the approved percentage for admission to the college or institute in accordance with the systems determined by the General People's Committee for Higher Education.'
String iQuEx =
