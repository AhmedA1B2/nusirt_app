...
import 'package:sirte_university/custom/home_screen/widget/logedin/personal_screen_t.dart';
import 'package:sirte_university/custom/home_screen/widget/logedin/shat_screen.dart';
...
class HomeScreenLogedT extends StatefulWidget {
  const HomeScreenLogedT({super.key});

  @override
  State<HomeScreenLogedT> createState() => _HomeScreenLogedTState();
}

class _HomeScreenLogedTState extends State<HomeScreenLogedT> {
  int _index = 3;
