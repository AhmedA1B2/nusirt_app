...
class HomeScreenLoged extends StatefulWidget {
  const HomeScreenLoged({
    Key? key,
  }) : super(key: key);

  @override
  State<HomeScreenLoged> createState() => _HomeScreenLogedState();
}

class _HomeScreenLogedState extends State<HomeScreenLoged> {
  int _index = 3;
  ...
  Widget build(BuildContext context) {
    List<Widget> pagesWidget = <Widget>[
      ...
      body: isDrawerOpen == false
          ? Transform(
              ...
              child: Transform.translate(
                ...
                child: pagesWidget.elementAt(_index),
              ),
            )
          : Stack(
              children: [
